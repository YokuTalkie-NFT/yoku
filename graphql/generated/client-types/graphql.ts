...
export type QueryNfTsByOwnerQuery = { __typename?: 'Query', NFTs: Array<{ __typename?: 'NFT', identifier: string, name: string, description: string, contract: string, tokenStandard: string, imageUrl?: string | null, metadataUrl?: string | null, updatedAt: string, creator: string, traits: Array<{ __typename?: 'Trait', traitType: string, value: string }>, owners: Array<{ __typename?: 'Owner', address: string, quantity: number }> }> };
...
export type PollingNfTsByOwnerQuery = { __typename?: 'Query', pollingNFTsAfterCreation: Array<{ __typename?: 'NFT', identifier: string, name: string, description: string, contract: string, tokenStandard: string, imageUrl?: string | null, metadataUrl?: string | null, updatedAt: string, creator: string, traits: Array<{ __typename?: 'Trait', traitType: string, value: string }>, owners: Array<{ __typename?: 'Owner', address: string, quantity: number }> }> };
